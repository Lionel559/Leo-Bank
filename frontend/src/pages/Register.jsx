...
function Register() {
 ...
 const handleImage = (e) => {
  ...
  if (file) {
    ...
    reader.onloadend = () => {
      setImage(reader.result) // ✅ base64 (permanent)
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // ✅ CONSISTENT USER OBJECT (VERY IMPORTANT)
        const userData = {
          name: form.name,
          email: form.email,
          phone: form.phone,
        ...
        // ✅ GO TO DASHBOARD DIRECTLY (BETTER UX)
        navigate("/login")
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="strength-bar">
            <div className={`strength level-${passwordStrength()}`}></div>
          </div>
